...
class ListUsuariosCapacitacionPage extends StatefulWidget {
  const ListUsuariosCapacitacionPage({super.key});

  @override
  State<ListUsuariosCapacitacionPage> createState() =>
      _ListUsuariosCapacitacionPageState();
}

class _ListUsuariosCapacitacionPageState
    extends State<ListUsuariosCapacitacionPage> {
  ...
  Future apiSearch(BuildContext context) async {
    resultSearch = await dio.get(
        ...
        queryParameters: {'buscar': buscar.text, "tipo": '2'});

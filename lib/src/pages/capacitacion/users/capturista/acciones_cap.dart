...
class ListAccionesCapturistaScreen extends StatefulWidget {
  const ListAccionesCapturistaScreen({super.key});

  @override
  State<ListAccionesCapturistaScreen> createState() =>
      _ListAccionesCapturistaScreenState();
}

class _ListAccionesCapturistaScreenState
    extends State<ListAccionesCapturistaScreen> {

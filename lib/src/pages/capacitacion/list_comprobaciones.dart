...
class ListComprobacionesScreen extends StatefulWidget {
  const ListComprobacionesScreen({super.key});

  @override
  State<ListComprobacionesScreen> createState() =>
      _ListComprobacionesScreenState();
}

class _ListComprobacionesScreenState extends State<ListComprobacionesScreen> {

...
class ListArtesanosScreen extends StatefulWidget {
  const ListArtesanosScreen({super.key});

  @override
  State<ListArtesanosScreen> createState() => _ListArtesanosScreenState();
}

class _ListArtesanosScreenState extends State<ListArtesanosScreen> {
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          OutlinedButton(
                              style: Styles().buttonReporteArtesanos(context),
                              onPressed: () async {
                                launchUrlString(
                                    '${GlobalVariable.baseUrlApi}scav/v1/artesanos/reporte?periodo=$annio');
                              },
                              child: Text(
                                "REPORTE",
                                style: TextStyle(fontSize: Adaptive.sp(12)),
  ...
  _bajaArtesano(BuildContext context, item) {
    // ignore: use_build_context_synchronously
    showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
            title: Container(
              ...
              color: Styles.rojo,
              child: const Center(
                child: Text("¿Está seguro de dar de baja este artesano?",
                    ...
                    ? Row(
                        ...
                        children: [
                          ElevatedButton(
                              ...
                              onPressed: () async {
                                if (await apiBajaArtesano(
                                        item['id_artesano'], 0, context) ==
                                    true) {
                                  // ignore: use_build_context_synchronously
                                  Navigator.pop(context);
                                  // ignore: use_build_context_synchronously
                                  Message().mensaje(Colors.green, Icons.done,
                                      'Baja realizada', context);
                                } else {
                                  // ignore: use_build_context_synchronously
                                  Navigator.pop(context);
                                  // ignore: use_build_context_synchronously
                                  Message().mensaje(Colors.red, Icons.error,
                                      'Error, inténtalo de nuevo.', context);
                                }
                              }),
                          SizedBox(
                            width: Adaptive.w(5),
  ...
  _altaArtesano(BuildContext context, item) {
    // ignore: use_build_context_synchronously
    showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
            title: Container(
              ...
              color: Styles.rojo,
              child: const Center(
                child: Text("¿Está seguro de dar de alta este artesano?",
                    style: TextStyle(color: Colors.white)),
              ),
            ),
            insetPadding: EdgeInsets.symmetric(
                    ...
                    ? Row(
                        ...
                        children: [
                          ElevatedButton(
                              ...
                              onPressed: () async {
                                if (await apiBajaArtesano(
                                        item['id_artesano'], 1, context) ==
                                    true) {
                                  // ignore: use_build_context_synchronously
                                  Navigator.pop(context);
                                  // ignore: use_build_context_synchronously
                                  Message().mensaje(Colors.green, Icons.done,
                                      'Alta realizada', context);
                                } else {
                                  // ignore: use_build_context_synchronously
                                  Navigator.pop(context);
                                  // ignore: use_build_context_synchronously

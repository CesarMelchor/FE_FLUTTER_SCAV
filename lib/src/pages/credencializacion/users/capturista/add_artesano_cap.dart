...
class AddArtesanoCapScreen extends StatefulWidget {
  const AddArtesanoCapScreen({super.key});

  @override
  State<AddArtesanoCapScreen> createState() => _AddArtesanoCapScreenState();
}

class _AddArtesanoCapScreenState extends State<AddArtesanoCapScreen> {
...
if (numero == 1) {
  setState(() {
    ...
    listDistritos =
        await dio.get('${GlobalVariable.baseUrlApi}scav/v1/distritos/$region');
    setState(() {
              ...
              Row(
                children: [
                  ElevatedButton.icon(
                      ...
                      onPressed: () {
                        Navigator.of(context).pushNamed("listArtesanosCap");
                      },
                      label: Text(
                        "LISTA DE PERSONAS",
                                ...
                                return snapshot.hasData
                                    ? CustomDropDownII.search(
                                        ...
                                        onChanged: (p0) {
                                          ...
                                          apiGetDistritos(
                                              VarAddArtesano.idRegionArtesano,1);
                                        },
                                        borderSide:
                              ...
                              child: getdistritos == false
                                  ? CustomDropDownII.search(
                                      ...
                                      onChanged: (p0) {
                                        ...
                                        apiGetMunicipios(
                                            VarAddArtesano.idDistritoArtesano,1);
                                      },
                                      borderSide:
                                          BorderSide(color: Styles.rojo),
                                      borderRadius: const BorderRadius.all(
                              ...
                              child: getmunicipios == false
                                  ? CustomDropDownII.search(
                                      ...
                                      onChanged: (p0) {
                                        ...
                                        apiGetLocalidades(
                                            VarAddArtesano.idMunicipioArtesano,1);
                                      },
                                      borderSide:
                                          BorderSide(color: Styles.rojo),
                                      borderRadius: const BorderRadius.all(
                                          ...
                                          Row(
                                            children: [
                                              SizedBox(
                                                width: Adaptive.w(30),
                                                height: Adaptive.h(5),
                                                child: getdistritos2 == false ? CustomDropDownII.search(
                                                  controller:
                                                ...
                                                ) : LinearProgressIndicator(color: Styles.rojo,),
                                              ),
                                              SizedBox(
                                                width: Adaptive.w(1),
                                              ),
                                              SizedBox(
                                                width: Adaptive.w(30),
                                                height: Adaptive.h(5),
                                                child: getmunicipios2 == false ? CustomDropDownII.search(
                                                  controller:
                                              ...
                                              SizedBox(
                                                width: Adaptive.w(30),
                                                height: Adaptive.h(5),
                                                child: getlocalidades2 == false ? CustomDropDownII.search(
                                                  controller:

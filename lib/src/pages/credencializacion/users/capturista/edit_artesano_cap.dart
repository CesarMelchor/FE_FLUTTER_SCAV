...
class ViewEditArtesanoCapScreen extends StatefulWidget {
  const ViewEditArtesanoCapScreen({super.key});

  @override
  State<ViewEditArtesanoCapScreen> createState() =>
      _ViewEditArtesanoCapScreenState();
}

class _ViewEditArtesanoCapScreenState extends State<ViewEditArtesanoCapScreen> {
